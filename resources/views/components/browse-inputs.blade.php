<div class="relative mt-32 sm:mt-24 px-10 font-semibold">
    ...
    <div class="flex gap-4 items-center flex-wrap mt-3">
        ...
        {{-- Language input --}}
        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdowna" class="text-white bg-[#333]
        ...
        <div id="dropdowna" class="z-10 hidden divide-y divide-gray-100 rounded-lg w-44 bg-[#333]">
