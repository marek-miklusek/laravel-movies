<x-master-layout>
    ...
    <div class="p-2 lg:p-7 mt-16 sm:mt-10 border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            {{-- Actor's details --}}
            <div class="md:ml-24">
                <h2 class="text-4xl mt-4 mb-2 md:mt-0 font-semibold text-white">{{ $actor['name'] }}</h2>
                <div class="flex flex-wrap gap-2 items-center text-gray-400 text-sm">
                    ...
                    <span>{{ $actor['birthday'] }} ({{ $actor['age'] }} years old) in {{ $actor['place_of_birth'] }}</span>
                </div>
                ...
                {{-- Known for --}}
                <h4 class="font-semibold mt-12 text-white">Known For</h4>
    ...
    <div class="p-2 lg:p-8">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold text-white">Films</h2>
            <ul class="list-disc leading-loose pl-5 mt-8 text-white">
                @foreach ($credits as $credit)
                    <li>
                        {{ $credit['release_year'] }} &middot;
                        <strong>
                            <a href="{{ $credit['linkToPage'] }}" class="text-orange-500 hover:text-orange-600 hover:underline">
                                {{ $credit['title'] }}
                            </a>
                        </strong>
                        as {{ $credit['character'] }}
